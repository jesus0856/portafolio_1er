        ...
        <section className="semana10">
            ...
            <div className="cont_10_1">
                ...
                <div className='cont_foto_10'>
                    ...
                    <img className="img_10_1" src="./recursos/ejercicio 10_1.png" alt="foto" />

                    <h3>Ejercicio práctico 10.2</h3>
                    <div className="cont_imgs_10_2">
                    <img className="img_10_2" src="./recursos/ejercicio 10_2_1.png" alt="foto" />
                    <img className="img_10_2" src="./recursos/ejercicio 10_2_2.png" alt="foto" />   
                    <img className="img_10_2" src="./recursos/ejercicio 10_2_3.png" alt="foto" /> 
                    </div>
